...
# --- Versioning ---
# v1.9
# - Implemented the History Heuristic for significantly improved move ordering.
...
class OpponentAI:
    ...
    def __init__(self, board, color, app, cancellation_event, bot_name="AI Bot"):
        ...
        # --- HISTORY HEURISTIC SETUP ---
        # A table to store scores for moves that caused cutoffs.
        # Indexed by [color_index][from_sq_idx][to_sq_idx]
        ...
        for move in ordered_moves:
            ...
            if alpha >= beta:
                ...
                if not is_capture:
                    ...
                    # This quiet move caused a beta-cutoff. Reward it.
